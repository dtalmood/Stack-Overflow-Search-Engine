...
complete --command curl --long-option 'ech' --description 'Configure Encrypted Client Hello (ECH) for use with the TLS session' 
...
complete --command curl --short-option 'i' --long-option 'include' --description 'Include response headers in output' 
...
complete --command curl --long-option 'location-trusted' --description 'Like --location, but send auth to other hosts' 
